...
.controller( 'SettingsGroupCtrl', ['$scope', function GroupCtrl( $scope) {
            ...
            FB.api(
                ...
                function (response) {
                    if (response && !response.error) {
                        ...
                        $scope.availableFriends = response.data;
                        $scope.$digest();
                    }
                }
            );
        ...
        $scope.removeFriend = function(friend){
            $scope.group.remove("friends",friend);
        ...
        $scope.addFriend = function(facebookId){
            ...
            query.find({
                success: function(friend) {
                    ...
                    $scope.group.addUnique('friends', friend[0]);
                    $scope.group.save(null, {
                        success: function(group) {
                            $scope.group = group;
                            $scope.$digest();
